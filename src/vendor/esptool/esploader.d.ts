 ...
 */
export declare type FlashReadCallback = ((packet: Uint8Array, progress: number, totalSize: number) => void) | null;
export declare class ESPLoader {
     ...
     */
    runSpiflashCommand(spiflashCommand: number, data: Uint8Array, readBits: number, addr?: number | null, addrLen?: number, dummyLen?: number): Promise<number>;
    /**
     ...
     */
    _updateImageFlashParams(image: string, address: number, flashMode?: FlashModeValues, flashFreq?: FlashFreqValues): Promise<string>;
    /**
    ...
    detectFlashSize(flashSize: FlashSizeValues): Promise<string>;
    /**
     ...
     */
    after(mode?: After, usingUsbOtg?: boolean, sequenceString?: string): Promise<void>;
}
